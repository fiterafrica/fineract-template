...
public class SavingsApiSetConstants extends SavingsApiConstants {
     ...
     */
    protected static final Set<String> SAVINGS_PRODUCT_RESPONSE_DATA_PARAMETERS = new HashSet<>(Arrays.asList(idParamName, nameParamName,
            ...
            taxGroupIdParamName, isDormancyTrackingActiveParamName, daysToInactiveParamName, withdrawalFrequencyParam, nextWithdrawalDate,
