...
public class TenantDatabaseUpgradeService implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        // LOG.warn("Liquibase is disabled because the current instance is configured as a non-write Fineract
        // instance");
        // }
        // return;
        // }
    ...
    // LOG.warn("Upgrading tenant store DB at {}:{}", fineractProperties.getTenant().getHost(),
    ...
    // ExtendedSpringLiquibase liquibase = liquibaseFactory.create(tenantDataSource, TENANT_STORE_DB_CONTEXT,
    ...
    // }
    // LOG.warn("This is the first Liquibase migration for {}. We'll sync the changelog for you and then apply
    // everything else", id);
