...
public class SavingsProductReadPlatformServiceImpl implements SavingsProductReadPlatformService {
    ...
    private static final class SavingProductMapper implements RowMapper<SavingsProductData> {
        ...
        SavingProductMapper() {
            ...
            sqlBuilder.append(
                    "sp.id as id,sp.withdrawal_frequency withdrawalFrequency, sp.name as name, sp.short_name as shortName, sp.description as description, ");
            sqlBuilder.append(
        ...
        public SavingsProductData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            ...
            final EnumOptionData withdrawalFrequencyEnum = SavingsEnumerations
                    .withdrawalFrequency(WithdrawalFrequency.fromInt(withdrawalFrequency));
